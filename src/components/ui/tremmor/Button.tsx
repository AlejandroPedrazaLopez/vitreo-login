  ...
  variants: {
    variant: {
      ...
      light: [
        ...
        // hover color
        "hover:bg-gray-100 hover:border-gray-400 dark:hover:bg-gray-700 dark:hover:border-gray-500",
        // disabled
        "disabled:bg-gray-100 disabled:text-gray-400 disabled:border-gray-200",
        "dark:disabled:bg-gray-800 dark:disabled:text-gray-600 dark:disabled:border-gray-700",
      ],
      ghost: [
        // base
        "shadow-none",
...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    return (
      <Component
        ref={forwardedRef}
        className={cx(buttonVariants({ variant }), className, size === "sm" && "text-xs", size === "md" && "text-sm", size === "lg" && "text-base")}
